...
const client = new ApolloClient({
  uri:
    "https://cors-anywhere.herokuapp.com/https://gbfs-graphql.vercel.app/api/graphql",
});
...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="maincontainer mb-5" id="mainContainer">
        ...
        <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mb-5 mx-auto text-center">
          <h1 className="display-4" id="display">
            Stations
          </h1>
          <p className="lead" id="lead">
            Details of stations Where Bikes and Docks availables
          </p>
        </div>
